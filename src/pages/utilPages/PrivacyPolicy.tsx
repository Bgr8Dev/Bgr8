        ...
        <div className="privacy-policy-container">
          ...
          <div className="privacy-policy-content">
            ...
            <ul>
              ...
              <li><p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Bgr8, 60 Benhill Avenue.</p></li>
              ...
              <li><p><strong>Website</strong> refers to Bgr8, accessible from <a href="https://www.bgr8.uk" rel="external nofollow noopener" target="_blank">https://www.bgr8.uk</a></p></li>
            ...
            <ul>
              <li>By visiting this page on our website: <a href="https://www.bgr8.uk" rel="external nofollow noopener" target="_blank">https://www.bgr8.uk</a></li>
            </ul>
          </div>
        </div>
      </main>
