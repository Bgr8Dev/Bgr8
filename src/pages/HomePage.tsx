...
export default function HomePage() {
  ...
  const services = [
    ...
    { icon: <FaGlobe size={40} />, title: 'B8 League', description: 'Passion for football.', link: '/b8-football-club', color: '#FFF', hoverColor: 'rgba(128, 0, 128, 0.5)', iconColor: '#FFF', iconHoverColor: '#000', restricted: true },
